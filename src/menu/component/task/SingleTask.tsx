...
const SingleTask: React.FC<Props> = ({title = "", status="", id=0}) => {
    ...
    return (
      <Fragment>
        ...
        <ModalPage modalVisible={visible}  setModalVisible={(value)=>{setVisible(value)}}  title={title} status={status} id={id}  />
      </Fragment>
